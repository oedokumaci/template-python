...
ifeq ($(OS),Windows_NT)
	(if exist .mypy_cache\\) rmdir .mypy_cache\\ /q /s
	(if exist .pytest_cache\\) rmdir .pytest_cache\\ /q /s
	(if exist .\\src\\template_python\\__pycache__\\) rmdir \\src\\template_python\\__pycache__\\ /q /s
	(if exist .\\tests\\__pycache__\\) rmdir .\\tests\\__pycache__\\ /q /s
else
	rm -rf .mypy_cache
	rm -rf .pytest_cache
